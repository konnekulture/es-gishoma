      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 py-20">
          <div className="max-w-2xl">
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-white mb-6 leading-tight brand-font">
              {config.heroTitle}
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative group">
              ...
              />
              <div className="absolute -bottom-6 -right-6 bg-indigo-600 px-6 py-6 sm:px-8 sm:py-8 rounded-2xl shadow-xl text-white hidden sm:block">
            ...
            <div>
              <span className="text-indigo-600 font-black tracking-[0.2em] uppercase text-xs mb-4 block">Welcome to ES GISHOMA</span>
              <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-slate-900 leading-tight brand-font">Investing In Our Student's Future</h2>
              <p className="text-slate-600 text-base sm:text-lg leading-relaxed mb-8 font-medium">
                {config.schoolBrief}
              </p>
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                {stats.map((stat, i) => (
                  <div key={i} className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-5 rounded-2xl bg-slate-50 border border-slate-100 hover:border-indigo-200 hover:bg-white hover:shadow-lg transition-all">
        ...
        <section className="py-20 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <span className="text-indigo-600 font-black tracking-[0.2em] uppercase text-[10px] mb-4 block">Campus Life</span>
                ...
                <div key={item.id} className="group relative aspect-video sm:aspect-square rounded-[2rem] overflow-hidden shadow-xl hover:-translate-y-2 transition-all duration-500">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-transparent to-transparent flex items-end p-8">
                    <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                      ...
                      <span className="px-3 py-1 bg-white/10 rounded-full text-[10px] uppercase font-black text-white tracking-widest backdrop-blur-md">
                        {item.category}
                      </span>
                    </div>
                  </div>
            ...
            <div className="mt-12 text-center">
              <Link to="/gallery" className="inline-flex items-center space-x-2 px-8 py-4 bg-white border border-slate-200 rounded-full font-bold text-slate-600 hover:bg-slate-900 hover:text-white hover:border-slate-900 transition-all shadow-sm">
              ...
              {announcements.map((ann) => (
                <div key={ann.id} className="bg-white rounded-[2rem] overflow-hidden shadow-lg border border-slate-100 group hover:shadow-2xl transition-all duration-500 flex flex-col h-full">
                  <div className="relative h-52 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 bg-indigo-600 text-white text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full shadow-lg">
                      {ann.category}
                    </div>
                  </div>
                  <div className="p-8 flex-1 flex flex-col">
                    ...
                    <h3 className="text-xl font-bold text-slate-900 mb-4 line-clamp-2 brand-font group-hover:text-indigo-600 transition-colors">{ann.title}</h3>
                    <p className="text-slate-600 text-sm mb-6 line-clamp-3 leading-relaxed font-medium">
                      {ann.content}
                    </p>
                    <Link to="/news" className="mt-auto text-indigo-600 font-black text-xs uppercase tracking-widest flex items-center hover:text-indigo-700">
          ...
          <div className="bg-slate-900 rounded-[3rem] p-10 sm:p-20 relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="max-w-xl text-center lg:text-left">
                <h2 className="text-3xl sm:text-5xl font-bold text-white mb-6 brand-font leading-tight">Begin Your Educational Journey With Us</h2>
                <p className="text-slate-400 text-lg sm:text-xl font-light">Join a community dedicated to innovation, character, and academic success.</p>
              </div>
